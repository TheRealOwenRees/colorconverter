...
describe('LCH -> RGB', () => {
  it('LCH to ColorObj', () => {
    ...
    expect(colorConvertor.getColorObj()).toMatchObject({ format: 'lch', value: { l: 50, c: 91, h: 298 } })
  })
...
describe('OKLCH -> Normalized RGB', () => {
  it('OKLCH to ColorObj', () => {
    const colorConvertor = new ColorConvertor('oklch(50%, 91, 298')
    expect(colorConvertor.getColorObj()).toMatchObject({ format: 'oklch', value: { l: 50, c: 91, h: 298 } })
  })
