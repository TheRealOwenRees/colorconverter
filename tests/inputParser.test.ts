...
describe('color parsing', () => {
  it('parse named color', () => {
    ...
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'name', value: 'f00' })
  })
  it('parse incorrect named color', () => {
    // @ts-expect-error
    const colorConvertorInstance = new ColorConvertor('resd')
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: undefined, value: undefined })
  })
  it('parse hex', () => {
    // @ts-expect-error
    const colorConvertorInstance = new ColorConvertor('#ffffff')
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'hex', value: 'ffffff' })
  })
  it('parse hexa', () => {
    // @ts-expect-error
    const colorConvertorInstance = new ColorConvertor('#ffffffcc')
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'hexa', value: 'ffffffcc' })
  })
  ...
  it('parse 3 digit hex', () => {
    ...
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'hex', value: 'fff' })
  })
  ...
  it('parse rgb', () => {
    ...
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'rgb', value: { r: 255, g: 255, b: 255 } })
  })
  ...
  it('parse rgba', () => {
    ...
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'rgba', value: { r: 255, g: 255, b: 255, a: 0.7 } })
  })
  ...
  it('parse hsl', () => {
    ...
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'hsl', value: { h: 305, s: 100, l: 54.5 } })
  })
  ...
  it('parse hsla', () => {
    ...
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'hsla', value: { h: 305, s: 100, l: 54.5, a: 0.5 } })
  })
  it('parse hsv', () => {
    // @ts-expect-error
    const colorConvertorInstance = new ColorConvertor('hsv(4, 96%, 54.5%)')
    expect(colorConvertorInstance.getInput()).toMatchObject({ format: 'hsv', value: { h: 4, s: 96, v: 54.5 } })
  })
})
