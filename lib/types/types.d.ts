export interface ColorConverterInterface {
    ...
    monochromatic: (numOfColors?: number, deltaS?: number, deltaL?: number) => HslObject[];
...
export interface ColorConversionInterface {
    ...
    findClosestColor: (rgb: RgbObject, namedColorsRgb: Record<string, RgbObject>) => string;
}
...
export interface PalettesInterface {
    ...
    monochromatic: (numOfColors: number, deltaS: number | undefined, deltaL: number | undefined, baseHsl: HslObject) => HslObject[];
}
