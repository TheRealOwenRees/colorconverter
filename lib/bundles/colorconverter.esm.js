...
const M1 = [[0.8189330101, 0.3618667424, -0.1288597137], [0.0329845436, 0.9293118715, 0.0361456387], [0.0482003018, 0.2643662691, 0.633851707]];
...
const invM1 = [[1.2270138511035211, -0.5577999806518222, 0.28125614896646783], [-0.04058017842328059, 1.1122568696168302, -0.07167667866560119], [-0.0763812845057069, -0.4214819784180127, 1.586163220440795]];
const invM2 = [[0.9999999984505199, 0.3963377921737679, 0.21580375806075883], [1.0000000088817609, -0.10556134232365635, -0.0638541747717059], [1.000000054672411, -0.08948418209496577, -1.291485537864092]];
...
function lrgbToRgb(lrgb) {
  ...
  return {
    ...
    g: fn(lrgb.g),
    b: fn(lrgb.b),
    a: (_a = lrgb.a) !== null && _a !== void 0 ? _a : undefined
  };
}
/*
...
function monochromatic(numOfColors, deltaS, deltaL, baseHsl) {
  ...
  const adjustedDeltaS = deltaS !== null && deltaS !== void 0 ? deltaS : 100 / adjustedNumOfColors;
  const adjustedDeltaL = deltaL !== null && deltaL !== void 0 ? deltaL : 100 / adjustedNumOfColors;
  const colors = [];
...
class ColorConverter {
  ...
  toHex() {
    var _a;
    return (_a = colorConversion.rgbToHex(colorConversion.rgbNormalizedToRgb(this.getRgbObj()))) !== null && _a !== void 0 ? _a : "";
  }
  /**
