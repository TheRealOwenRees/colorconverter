...
class ColorConvertor {
  constructor(colorInput) {
    ...
    this._rgbObj = toRgbBase(this._colorObj).value; // RGB values object. E.g. { r: 255, g: 255, b: 255 }
  }
  ...
  */
  ...
  setColor(color) {
    ...
    this._rgbObj = toRgbBase(this.getColorObj()).value;
  }
