...
var M1 = [[0.8189330101, 0.3618667424, -0.1288597137], [0.0329845436, 0.9293118715, 0.0361456387], [0.0482003018, 0.2643662691, 0.633851707]];
var M2 = [[0.2104542553, 0.793617785, -0.0040720468], [1.9779984951, -2.428592205, 0.4505937099], [0.0259040371, 0.7827717662, -0.808675766]];
...
function okLabToLinearRbg(oklab) {
  ...
  var S = oklab.l / 100 - 0.0894841775 * oklab.a - 1.291485548 * oklab.b;
  L = L * L * L;
  M = M * M * M;
  S = S * S * S;
  return {
...
function findClosestColor(rgb, namedColorsRgb) {
  ...
  var closestColor = "";
  var lab1 = xyzToLab(rgbToXyz(rgb));
  for (var color in namedColorsRgb) {
    var lab2 = xyzToLab(rgbToXyz(namedColorsRgb[color]));
    var distance = (0, _utilities.labDeltaE)(lab1, lab2);
