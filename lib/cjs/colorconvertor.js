...
class ColorConvertor {
  ...
  toHslString() {
    const {
      ...
      s,
      l
    } = (0, _conversions.rgbNormalizedToHsl)(this.getRgbObj());
    return `hsl(${h}, ${s}%, ${l}%)`;
  }
   ...
   */
  toHex() {
    return (0, _conversions.rgbToHex)((0, _conversions.rgbNormalizedToRgb)(this.getRgbObj())) ?? "";
  }
  ...
  toHex8() {
    const {
      ...
      g,
      b
    } = (0, _conversions.rgbNormalizedToRgb)(this.getRgbObj());
   ...
   */
  toName() {
    const hex = (0, _utilities.truncateHex)(this.toHex());
    for (const color in _namedColors.default) {
   ...
   */
  toNearestNamedColor() {
    const rgb = (0, _conversions.rgbNormalizedToRgb)(this.getRgbObj());
    return (0, _conversions.findClosestColor)(rgb, _namedColors.namedColorsRgb);
  }
