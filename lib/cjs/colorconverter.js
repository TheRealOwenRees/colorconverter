...
var _palettes = _interopRequireDefault(require("./utils/palettes"));
...
class ColorConverter {
  ...
  toHsl() {
    ...
    return format === "hsv" ? value : _conversions.default.rgbNormalizedToHsl(this.getRgbObj());
  }
  ...
  random() {
    this.setColorObj({
      format: "rgb",
      value: _utilities.default.randomRgbColor()
    });
    this.setRbgObj(_conversions.default.toRgbBase(this.getColorObj()));
  }
  ...
  readability(color2) {
    ...
    return _utilities.default.calculateContrastRatio(l1, l2);
  }
   ...
   */
  isReadable(color2) {
    return _utilities.default.calculateReadability(this.readability(color2));
  }
   ...
   */
  complementary() {
    return _palettes.default.analogous(2, this.toHsl());
  }
   ...
   */
  triadic() {
    return _palettes.default.analogous(3, this.toHsl());
  }
   ...
   */
  tetradic() {
    return _palettes.default.analogous(4, this.toHsl());
  }
  ...
  splitComplementary(numOfColors = 5) {
    return _palettes.default.analogous(numOfColors, this.toHsl());
  }
  ...
  monochromatic(numOfColors = 3, deltaS = undefined, deltaL = undefined) {
    return _palettes.default.monochromatic(numOfColors, deltaS, deltaL, this.toHsl());
  }
